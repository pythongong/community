...
CREATE TABLE community_post (
    id BIG_INT AUTO_INCREMENT PRIMARY KEY COMMENT 'Unique auto-incrementing integer identifier for each post',
    ...
    create_user_id BIG_INT NOT NULL COMMENT 'ID of the user who created the post',
    update_user_id BIG_INT NOT NULL COMMENT 'ID of the user who last updated the post'.
